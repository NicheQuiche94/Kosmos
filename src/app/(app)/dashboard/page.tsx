...
const WEEKLY_TEMPLATE: Record<number, ScheduleBlock[]> = {
  1: [ // Monday: Upper body + Content + BD
    ...
    { id: "m3", time: "7:30", title: "Breakfast + supplements", type: "habit", color: "#4A8C6F" },
    { id: "m4", time: "8:00", title: "Content + video creation", type: "focus_block", color: "#2C5F8A" },
    { id: "m5", time: "12:00", title: "Lunch", type: "habit", color: "#4A8C6F" },
    ...
    { id: "m8", time: "17:30", title: "Dinner", type: "habit", color: "#4A8C6F" },
  ...
  2: [ // Tuesday: Lower body + Deep work
    ...
    { id: "t3", time: "7:30", title: "Breakfast + supplements", type: "habit", color: "#4A8C6F" },
    { id: "t4", time: "8:30", title: "Deep work -- Strategy + Product", type: "focus_block", color: "#2C5F8A" },
    { id: "t5", time: "12:00", title: "Lunch", type: "habit", color: "#4A8C6F" },
    { id: "t6", time: "13:00", title: "Writing + copy + marketing", type: "focus_block", color: "#0891B2" },
    { id: "t7", time: "17:30", title: "Family time", type: "personal", protected: true, color: "#DC2626" },
    { id: "t8", time: "17:30", title: "Dinner", type: "habit", color: "#4A8C6F" },
  ...
  3: [ // Wednesday: Run + Deep work
    { id: "w1", time: "6:00", title: "Morning routine + mobility", type: "habit", protected: true, color: "#65A30D" },
    { id: "w2", time: "6:30", title: "Run -- 5k training", type: "habit", color: "#4A8C6F" },
    { id: "w3", time: "7:30", title: "Breakfast + supplements", type: "habit", color: "#4A8C6F" },
    { id: "w4", time: "8:30", title: "Deep work -- Strategy + Product", type: "focus_block", color: "#2C5F8A" },
    { id: "w5", time: "12:00", title: "Lunch", type: "habit", color: "#4A8C6F" },
    { id: "w6", time: "13:00", title: "Writing + copy + marketing", type: "focus_block", color: "#0891B2" },
    { id: "w7", time: "17:30", title: "Family time", type: "personal", protected: true, color: "#DC2626" },
    { id: "w8", time: "17:30", title: "Dinner", type: "habit", color: "#4A8C6F" },
  ...
  4: [ // Thursday: Upper body + Admin
    ...
    { id: "th3", time: "7:30", title: "Breakfast + supplements", type: "habit", color: "#4A8C6F" },
    { id: "th4", time: "9:00", title: "Admin + async comms", type: "focus_block", color: "#D97706" },
    { id: "th5", time: "12:00", title: "Lunch", type: "habit", color: "#4A8C6F" },
    { id: "th6", time: "17:30", title: "Family time", type: "personal", protected: true, color: "#DC2626" },
    { id: "th7", time: "17:30", title: "Dinner", type: "habit", color: "#4A8C6F" },
    { id: "th8", time: "19:00", title: "Dog walk + audiobook", type: "habit", protected: true, color: "#4A8C6F" },
    { id: "th9", time: "21:30", title: "Wind down", type: "habit", protected: true, color: "#6B7280" },
  ],
  5: [ // Friday: Lower body + Content + BD + Weekly review
    ...
    { id: "f3", time: "7:30", title: "Breakfast + supplements", type: "habit", color: "#4A8C6F" },
    { id: "f4", time: "8:00", title: "Content + video creation", type: "focus_block", color: "#2C5F8A" },
    { id: "f5", time: "12:00", title: "Lunch", type: "habit", color: "#4A8C6F" },
    ...
    { id: "f8", time: "17:30", title: "Family time", type: "personal", protected: true, color: "#DC2626" },
    { id: "f9", time: "17:30", title: "Dinner", type: "habit", color: "#4A8C6F" },
  ...
  6: [ // Saturday: Full body + Run
    ...
    { id: "sa3", time: "9:15", title: "Run -- 5k training", type: "habit", color: "#4A8C6F" },
    { id: "sa4", time: "10:15", title: "Breakfast + supplements", type: "habit", color: "#4A8C6F" },
    { id: "sa5", time: "11:00", title: "Family day", type: "personal", protected: true, color: "#DC2626" },
    { id: "sa6", time: "12:30", title: "Lunch", type: "habit", color: "#4A8C6F" },
    { id: "sa7", time: "17:30", title: "Dinner", type: "habit", color: "#4A8C6F" },
  ...
  0: [ // Sunday: Rest + family
    { id: "su1", time: "7:00", title: "Morning routine + mobility", type: "habit", protected: true, color: "#65A30D" },
    { id: "su2", time: "7:30", title: "Breakfast", type: "habit", color: "#4A8C6F" },
    { id: "su3", time: "10:00", title: "Rest + family day", type: "personal", protected: true, color: "#DC2626" },
    { id: "su4", time: "12:30", title: "Lunch", type: "habit", color: "#4A8C6F" },
    { id: "su5", time: "17:30", title: "Dinner", type: "habit", color: "#4A8C6F" },
    { id: "su6", time: "19:00", title: "Dog walk + audiobook", type: "habit", protected: true, color: "#4A8C6F" },
    { id: "su7", time: "20:00", title: "Weekly planning session", type: "action", color: "#D97706" },
    { id: "su8", time: "21:30", title: "Wind down", type: "habit", protected: true, color: "#6B7280" },
  ],
};
